...
contract USDT_Exchcoin_Exchange {
    ...
    function exchcoinToUSDT (uint256 _v) public {
        ...
        exchcoinToUSDTCoinDeliver(_v);
    }
    
    function exchcoinToUSDTCoinDeliver(uint256 _v) public {
        uint256 pltf_fee = 0;
    ...
    function USDTToExchcoin (uint256 _v) public {
        ...
        USDTtoExchcoinCoinDeliver(_v);
    }
    
    function USDTtoExchcoinCoinDeliver(uint256 _v) public{
